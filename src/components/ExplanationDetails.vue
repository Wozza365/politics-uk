...
<template>
  <div v-if="explanation" class="absolute inset-0 z-50 flex items-center justify-center bg-zinc-950/55 px-4" role="dialog" aria-modal="true">
    <section class="max-h-[calc(100vh-4rem)] w-[min(42rem,100%)] overflow-y-auto rounded-lg border border-zinc-700 bg-zinc-950 p-5 text-sm text-zinc-200 shadow-2xl">
