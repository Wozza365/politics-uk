...
| Party history snapshots (polling, finance, membership, seat totals) | Phase 1 ships with synthetic dated snapshots for the MVP UI; real monthly history should be gathered in Phase 2 |
...
- The main bottom tab bar includes **County** and **Local** map granularities. County
